...
This script implements the training of a MelGAN for generating new sounds that are then combined for new sonority. The idea is presented in paper [1], while the training is based on the MelGAN one [2] and available at: https://github.com/descriptinc/melgan-neurips/blob/master/scripts/train.py
