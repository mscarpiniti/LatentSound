...
#
# This script implements the training of a MelGAN for generating new sounds
# that are then combined for new sonority.
# The idea is presented in paper [1], while the training is based on the
# MelGAN architecture [2] whose source code is available at:
# https://github.com/descriptinc/melgan-neurips/blob/master/scripts/train.py
#
...
# Standard code of MelGAN (https://github.com/descriptinc/melgan-neurips)
import sys
...
# Changed default values to fit our problem
def parse_args():
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        for iterno, x_t in enumerate(train_loader):
            ...
            netG.zero_grad()
            (loss_G + args.lambda_feat * loss_feat).backward(retain_graph=True)
            optG.step()
